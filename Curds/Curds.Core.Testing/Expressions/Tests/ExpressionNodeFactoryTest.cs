...
namespace Curds.Expressions.Tests
{
    ...
    public class ExpressionNodeFactoryTest
    {
        ...
        private Expression TestGreaterThanExpression => Expression.GreaterThan(TestConstantZero, TestConstantOne);

        [TestMethod]
        public void GreaterThanExpressionIsExpected()
        {
            Expression testExpression = TestGreaterThanExpression;

            IExpressionNode actual = TestObject.Build(testExpression);

            GreaterThanNode actualNode = actual.VerifyIsActually<GreaterThanNode>();
            Assert.AreSame(testExpression, actualNode.SourceExpression);
        }

        [TestMethod]
        public void GreaterThanExpressionHasExpectedLeft()
        {
            IExpressionNode actual = TestObject.Build(TestGreaterThanExpression);
        ...
        [TestMethod]
        public void GreaterThanExpressionHasExpectedRight()
        {
            IExpressionNode actual = TestObject.Build(TestGreaterThanExpression);
        ...
        private Expression TestGreaterThanOrEqualExpression => Expression.GreaterThanOrEqual(TestConstantZero, TestConstantOne);
        ...
        [TestMethod]
        public void GreaterThanOrEqualExpressionHasExpectedLeft()
        {
