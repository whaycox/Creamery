...
namespace Curds.Cron.RangeFactories.Links.Tests
{
    ...
    [TestClass]
    public class NearestWeekdayLinkTest : BaseLinkTemplate
    {
        private DayOfMonthFieldDefinition TestFieldDefinition = new DayOfMonthFieldDefinition();

        private NearestWeekdayLink TestObject = null;
        protected override IRangeFactoryLink InterfaceTestObject => TestObject;

        [TestInitialize]
        public void Init()
        {
            TestObject = new NearestWeekdayLink(TestFieldDefinition, MockRangeLink.Object);
        }
