...
namespace Curds.Cron.RangeFactories.Links.Tests
{
    ...
    [TestClass]
    public class LastDayOfWeekLinkTest : BaseLinkTemplate
    {
        private DayOfWeekFieldDefinition TestFieldDefinition = new DayOfWeekFieldDefinition();

        private LastDayOfWeekLink TestObject = null;
        protected override IRangeFactoryLink InterfaceTestObject => TestObject;

        [TestInitialize]
        public void Init()
        {
            TestObject = new LastDayOfWeekLink(TestFieldDefinition, MockRangeLink.Object);
        }
