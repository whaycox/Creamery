...
namespace Curds.Infrastructure.Cron.Token.Tests.Cases.Hour
{
    public class BusinessHours : CronCase<Token.Hour>
    {
        public override IEnumerable<Token.Hour> Samples
        {
            get
            {
                yield return new Token.Hour("9-17");
            }
        }
