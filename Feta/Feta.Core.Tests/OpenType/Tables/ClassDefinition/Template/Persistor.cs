...
namespace Feta.OpenType.Tables.ClassDefinition.Template
{
    ...
    public abstract class Persistor<T> : ITablePersistor<ClassDefinition.Persistor<T>, Table>
        where T : PrimaryTable
    {
        protected void PrimeReader(Table sample)
        {
        ...
        private void PrimeFormatOne(Table sample)
        {
        ...
        private void PrimeFormatTwo(Table sample)
        {
        ...
        protected void VerifyTableWasWritten(Table expected)
        {
        ...
        private void VerifyFormatOneWasWritten(Table expected)
        {
        ...
        private void VerifyFormatTwoWasWritten(Table expected)
        {
