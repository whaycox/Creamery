...
namespace Feta.OpenType.Tables.GDEF.Implementation
{
    ...
    public class LigatureCaretListPersistor : SubtablePersistor<GdefTable, LigatureCaretList>
    {
        ...
        protected override void AttachSubtable(GdefTable parentTable, LigatureCaretList subTable) => parentTable.LigatureCaretList = subTable;

        protected override void Write(IFontWriter writer, LigatureCaretList table)
        {
